...
#
cat dodatkowe/ps-aux | awk 'NR>1 {cpu+=$3; ram+=$4} END {print "CPU: " cpu "\nRAM: " ram}'
# dla każdej linii poza pierwszą dodajemy do zmiennych cpu i ram odpowiednie wartości
# na końcu wypisujemy wartości zmiennych
# domyślnym znakiem separatora jest spacja, więc nie musimy go podawać
